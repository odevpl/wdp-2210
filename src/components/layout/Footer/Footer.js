    ...
    <div className={styles.footerMenu}>
      <div className='container'>
        <div className='row'>
          ...
          <div className={'col-6 col-md-3 ' + styles.orders}>
            <div className={styles.menuWrapper}>
              <h6>Orders</h6>
              <ul>
                <li>
    ...
    <div className={styles.bottomBar}>
      <div className='container'>
        <div className='row align-items-center'>
          <div className='col-12 col-sm-12 col-md-4 text-center '></div>
          <div className={'col-6 col-md-4 text-center ' + styles.copyright}>
            <p>©Copyright 2016 Bazar | All Rights Reserved</p>
          </div>
          <div className={'col-6 col-md-4 text-right ' + styles.socialMedia}>
            <ul>
              <li>
                <a href='#'>
